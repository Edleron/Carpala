...
IL_0035:
	{
		...
		V_1 = L_10;
		int32_t L_11 = V_1;
		Dictionary_2_Resize_mDA2C2B2AA9D036744EA1510458F902ACF49E6658(__this, L_11, (bool)0, il2cpp_rgctx_method(method->klass->rgctx_data, 53));
		int32_t L_12 = V_1;
		return L_12;
	}
}
...
IL_0035:
	{
		...
		V_1 = L_10;
		int32_t L_11 = V_1;
		Dictionary_2_Resize_mAA34C20A111880E1891639C7022D73FED4DCE18B(__this, L_11, (bool)0, il2cpp_rgctx_method(method->klass->rgctx_data, 53));
		int32_t L_12 = V_1;
		return L_12;
	}
}
